...
x_start_mm = -lineLength/2*ones(size(vLinePositions));
x_end_mm   = +lineLength/2*ones(size(vLinePositions));
y_start_mm = vLinePositions*base+vLineBias;
y_end_mm   = vLinePositions*base+vLineBias;

% Define lines from pattern - h
x_start_mm = [x_start_mm  hLinePositions*base+hLineBias];
x_end_mm   = [x_end_mm    hLinePositions*base+hLineBias];
y_start_mm = [y_start_mm -lineLength/2*ones(size(hLinePositions))];
y_end_mm   = [y_end_mm   +lineLength/2*ones(size(hLinePositions))];
